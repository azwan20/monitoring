    ...
    <main>
        ...
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px; min-height: calc(100vh)">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="monitoring.php?data=0" class="nav-link link-dark active">
                        <svg class="bi me-2" width="16" height="16">
                ...
                <div class="card-body">
                    <form action="input.php" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="laboratorium">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="praktikum">
                                <option value="RPL">Basis Data 2</option>
                                <option value="Industri">Jaringan Tingkat Lanjut</option>
                                <option value="Multimedia">Algoritma dan Pemrograman 2</option>
